...
//             {
//                 // System.err.println(Json.encodePrettily(finalHandler.result()));
//                 // String url = "https://192.168.8.115:8086/dbob/edd/protected/v1/edd/case/action/by/signavio";
//                 // WebClientHelper.postJson(url,Json.encodePrettily(finalHandler.result()));
...
//         JsonObject result = new JsonObject(client.post(Json.encodePrettily(caseObj.getJsonArray("participants")), String.class));
//         finalHandler.handle(Future.succeededFuture(result));
//     }    
